...
import com.zwl.mall.common.*;
import com.zwl.mall.controller.vo.*;
import com.zwl.mall.dao.NewBeeMallGoodsMapper;
import com.zwl.mall.dao.NewBeeMallOrderItemMapper;
import com.zwl.mall.dao.NewBeeMallOrderMapper;
import com.zwl.mall.dao.NewBeeMallShoppingCartItemMapper;
import com.zwl.mall.entity.NewBeeMallGoods;
import com.zwl.mall.entity.NewBeeMallOrder;
import com.zwl.mall.entity.NewBeeMallOrderItem;
...
import com.zwl.mall.util.NumberUtil;
...
public class NewBeeMallOrderServiceImpl implements NewBeeMallOrderService {
    ...
    public String saveOrder(NewBeeMallUserVO user, List<NewBeeMallShoppingCartItemVO> myShoppingCartItems) {
        ...
        List<NewBeeMallGoods> goodsListNotSelling = newBeeMallGoods.stream()
                .filter(newBellMallGoodsTemp -> newBellMallGoodsTemp.getGoodsSellStatus() != Constants.SELL_STATUS_UP)
    ...
    @Override
    public NewBeeMallOrderDetailVO getOrderDetailByOrderNo(String orderNo) {
        ...
        if(newBeeMallOrder != null){
            ...
            if(!CollectionUtils.isEmpty(orderItems)){
                ...
                newBeeMallOrderDetailVO.setPayStatusString(PayTypeEnum.getPayTypeEnumByType(newBeeMallOrderDetailVO.getPayType()).getName());
