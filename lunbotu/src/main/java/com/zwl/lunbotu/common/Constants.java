package com.zwl.lunbotu.common;

/**
 * 常量配置
 * */
public class Constants {
    public static final String FILE_UPLOAD_DIC = "D:\\mall\\upload\\"; //上传文件的默认url前缀
    ...
    public static final int SEARCH_CATEGORY_NUMBER = 8; //搜索页一级分类的最大数量
    public static final int SHOPPING_CART_ITEM_LIMIT_NUMBER = 5; //购物车中单个商品的最大购买数量(可根据自身需求修改)
    public static final int SHOPPING_CART_ITEM_TOTAL_NUMBER = 13; //购物车中商品的最大数量(可根据自身需求修改)
